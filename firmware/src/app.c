...
static void USART_Task (void)
{
    switch (usartRWState)
    {
        ...
        case USART_RW_INIT:
        {
            appData.usartReadWriteTxIndex = 0;
        ...
        {
            if(appData.usartReadWriteTxIndex < sizeof(usartRWTxData))
            {
                /* Transmit the bytes from the buffer */
                appData.usartReadWriteTxIndex += 
                    DRV_USART_Write(appData.handleUSART0,
                    &usartRWTxData[appData.usartReadWriteTxIndex],
                    sizeof(usartRWTxData) - appData.usartReadWriteTxIndex);
            }
