...
void SYS_PORTS_Initialize(void)
{
    ...
    PLIB_PORTS_RemapOutput(PORTS_ID_0, OUTPUT_FUNC_SCK3, OUTPUT_PIN_RPC9 );
    PLIB_PORTS_RemapOutput(PORTS_ID_0, OUTPUT_FUNC_SDO3, OUTPUT_PIN_RPD5 );
    PLIB_PORTS_RemapOutput(PORTS_ID_0, OUTPUT_FUNC_SCK3, OUTPUT_PIN_RPC9 );
    PLIB_PORTS_RemapOutput(PORTS_ID_0, OUTPUT_FUNC_SCK3, OUTPUT_PIN_RPC9 );
    PLIB_PORTS_RemapOutput(PORTS_ID_0, OUTPUT_FUNC_SDO2, OUTPUT_PIN_RPB5 );
    PLIB_PORTS_RemapOutput(PORTS_ID_0, OUTPUT_FUNC_SCK3, OUTPUT_PIN_RPC9 );
    PLIB_PORTS_RemapOutput(PORTS_ID_0, OUTPUT_FUNC_SCK3, OUTPUT_PIN_RPC9 );
    PLIB_PORTS_RemapOutput(PORTS_ID_0, OUTPUT_FUNC_SDO1, OUTPUT_PIN_RPA8 );
    PLIB_PORTS_RemapOutput(PORTS_ID_0, OUTPUT_FUNC_REFCLKO4, OUTPUT_PIN_RPB15 );
    PLIB_PORTS_RemapOutput(PORTS_ID_0, OUTPUT_FUNC_REFCLKO1, OUTPUT_PIN_RPG8 );
    PLIB_PORTS_RemapOutput(PORTS_ID_0, OUTPUT_FUNC_SDO1, OUTPUT_PIN_RPA8 );
    PLIB_PORTS_RemapOutput(PORTS_ID_0, OUTPUT_FUNC_SDO2, OUTPUT_PIN_RPB5 );
    PLIB_PORTS_RemapOutput(PORTS_ID_0, OUTPUT_FUNC_U1TX, OUTPUT_PIN_RPC7 );
    PLIB_PORTS_RemapOutput(PORTS_ID_0, OUTPUT_FUNC_SDO3, OUTPUT_PIN_RPD5 );
    PLIB_PORTS_RemapOutput(PORTS_ID_0, OUTPUT_FUNC_SS3, OUTPUT_PIN_RPF0 );
    PLIB_PORTS_RemapOutput(PORTS_ID_0, OUTPUT_FUNC_SCK3, OUTPUT_PIN_RPC9 );
    PLIB_PORTS_RemapOutput(PORTS_ID_0, OUTPUT_FUNC_REFCLKO3, OUTPUT_PIN_RPC8 );
    PLIB_PORTS_RemapOutput(PORTS_ID_0, OUTPUT_FUNC_SS1, OUTPUT_PIN_RPB13 );
