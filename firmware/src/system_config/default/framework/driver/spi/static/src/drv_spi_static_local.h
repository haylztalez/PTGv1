...
int32_t DRV_SPI0_MasterEBMSend16BitISR( struct DRV_SPI_OBJ * dObj );
int32_t DRV_SPI0_MasterEBMReceive16BitISR( struct DRV_SPI_OBJ * dObj );

int32_t DRV_SPI1_ISRMasterEBM16BitTasks ( struct DRV_SPI_OBJ * dObj );
int32_t DRV_SPI1_ISRErrorTasks(struct DRV_SPI_OBJ * dObj);
int32_t DRV_SPI1_MasterEBMSend16BitISR( struct DRV_SPI_OBJ * dObj );
int32_t DRV_SPI1_MasterEBMReceive16BitISR( struct DRV_SPI_OBJ * dObj );

int32_t DRV_SPI2_ISRMasterEBM16BitTasks ( struct DRV_SPI_OBJ * dObj );
int32_t DRV_SPI2_ISRErrorTasks(struct DRV_SPI_OBJ * dObj);
int32_t DRV_SPI2_MasterEBMSend16BitISR( struct DRV_SPI_OBJ * dObj );
int32_t DRV_SPI2_MasterEBMReceive16BitISR( struct DRV_SPI_OBJ * dObj );
// DOM-IGNORE-BEGIN
#ifdef __cplusplus
}
#endif
